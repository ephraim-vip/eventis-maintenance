    ...
    return (
      <div className="min-h-screen bg-gray-50 overflow-x-hidden">
        ...
        <div className="flex flex-col items-center justify-center py-32 px-6 text-center">
          ...
          <Link
            to="/evenements"
            className="text-sm font-bold text-red-500 no-underline"
          >
    ...
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50">
          <div className="bg-white rounded-2xl p-8 max-w-md w-full shadow-2xl text-center">
            ...
            <p className="text-sm text-gray-500 mb-6">
              Votre inscription au <strong>{evenement.titre}</strong> a bien été
              enregistrée. Un email de confirmation vous a été envoyé avec un
            ...
            <div className="bg-gray-50 rounded-xl p-4 text-left mb-6 space-y-3">
              <div className="flex justify-between text-sm border-b border-gray-100 pb-2">
                ...
                <span className="font-semibold text-gray-900 text-right max-w-[60%] line-clamp-1">
                  {evenement.titre}
                </span>
              </div>
              <div className="flex justify-between text-sm border-b border-gray-100 pb-2">
                ...
                <span className="font-semibold text-gray-900">
                  {datePartDebut} {heurePartDebut}
                </span>
              </div>
              <div className="flex justify-between text-sm border-b border-gray-100 pb-2">
                <span className="text-gray-400">Lieu</span>
                <span className="font-semibold text-gray-900">
                  {evenement.lieu || evenement.localisation?.libelle}
                </span>
              </div>
      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-6 lg:px-8 py-10 lg:py-16">
        ...
        <div className="flex items-center gap-2 text-sm text-gray-500 mb-8 overflow-hidden">
          <Link
            to="/evenements"
            className="hover:text-gray-700 flex items-center gap-1 no-underline transition-colors shrink-0"
          >
            <ArrowLeft size={15} />
            Les événements
          </Link>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-10 lg:gap-12 items-start">
          ...
          <div className="lg:col-span-1">
            <div className="bg-white border border-gray-200 rounded-2xl p-6 lg:sticky lg:top-24">
              {/* Titre carte */}
              <div className="font-black text-gray-900 text-lg mb-5">
                ...
                {evenement.date_fin && (
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <div className="text-sm font-semibold text-gray-900">
                        {evenement.date_fin.split(" ")[0]}{" "}
                        {evenement.date_fin.split(" ")[1] && (
                          <span className="text-red-500 ">
                            à {evenement.date_fin.split(" ")[1]}
                          </span>
                        )}
                      </div>
                    </div>
              ...
              {evenement.statut !== "publie" ? (
                ...
                <>
                  ...
                  >
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) => {
                          setForm({ ...form, nom_participant: e.target.value });
                          setErrors({});
                        }}
                      ...
                      {errors.nom_participant && (
                        <p className="text-xs text-red-500 mt-1">
                          {errors.nom_participant[0]}
                        </p>
                      )}
                    </div>
                    <div>
                      <label
                        htmlFor="email_participant"
                        className="block text-xs font-semibold uppercase tracking-wider text-gray-500 mb-2"
                      >
                        Adresse email
                      </label>
                      <input
                        ...
                        onChange={(e) => {
                          setForm({
                            ...form,
                            email_participant: e.target.value,
                          });
                          setErrors({});
                        }}
                      ...
                      {errors.email_participant && (
                        <p className="text-xs text-red-500 mt-1">
                          {errors.email_participant[0]}
                        </p>
                      )}
                    </div>

                    <p className="text-xs text-gray-400 leading-relaxed pt-1">
                      Les données saisies permettent de gérer votre inscription
                      à cet événement. Un lien de désinscription vous sera
                      envoyé par email — voir notre{" "}
                      <a
                  ...
                  <div className="flex items-center justify-center gap-1.5 text-xs text-gray-400 mt-3">
                    <ShieldCheck size={12} />
                    <span>
                      Un lien de désinscription vous sera envoyé par email
                    </span>
                  </div>
                </>
              )}
