    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-6 lg:px-8 py-10 lg:py-16 overflow-x-hidden">
        ...
        <div className="flex gap-8 items-start">
          {/* Panneau filtres */}
          <aside
            className={`${showFiltersMobile ? "block" : "hidden"} lg:block w-full lg:w-72 shrink-0`}
          >
            <form
            ...
            >
              ...
              <div className="mb-6">
                ...
                <div className="space-y-2.5">
                  {categories.map((cat) => {
                    const inputId = `categorie-${cat.id}`;
                    const checked = filters.categorie_id === String(cat.id);
                    return (
                      <label
                        key={cat.id}
                        htmlFor={inputId}
                      ...
                      >
                        <input
                          ...
                          onChange={() =>
                            setFilters({
                              ...filters,
                              categorie_id: checked ? "" : String(cat.id),
                            })
                          }
                          className="sr-only"
                        />
              ...
              <div className="mb-6">
                ...
                <select
                  ...
                  onChange={(e) =>
                    setFilters({ ...filters, localisation_id: e.target.value })
                  }
