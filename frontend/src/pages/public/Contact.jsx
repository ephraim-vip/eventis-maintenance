        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-start">
          ...
          <div>
            ...
            <p className="text-gray-500 text-base leading-relaxed mb-10">
              Vous souhaitez publier votre événement sur Éventis, ou vous avez
              une question sur la plateforme ? Notre équipe est disponible et
              répondra dans les 24h.
            </p>
            ...
            <div className="space-y-6">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <div className="text-xs font-bold uppercase tracking-wide text-gray-400 mb-0.5">
                    Email
                  </div>
          ...
          <div className="bg-gray-900 border border-gray-700 rounded-2xl p-6 sm:p-8">
            ...
            <form onSubmit={handleSubmit} noValidate className="space-y-4">
              <div>
                ...
                />
                {errors.nom && (
                  <p className="text-xs text-red-400 mt-1">{errors.nom[0]}</p>
                )}
              </div>
              ...
              <div>
                ...
                />
                {errors.sujet && (
                  <p className="text-xs text-red-400 mt-1">{errors.sujet[0]}</p>
                )}
              </div>
              ...
              <p className="text-xs text-gray-400 leading-relaxed pt-1">
                Vos données ne sont pas conservées : elles sont utilisées
                uniquement pour traiter votre demande et vous répondre. Voir
                notre{" "}
                <a
